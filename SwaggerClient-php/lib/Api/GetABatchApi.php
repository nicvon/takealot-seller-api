...
/**
 * GetABatchApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class GetABatchApi
{
     ...
     * @param  string $batch_id The ID of the batch you have submitted, provided to you by Takealot (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OfferBatch
     */
    public function getBatch($version, $batch_id)
    {
        list($response) = $this->getBatchWithHttpInfo($version, $batch_id);
        return $response;
    }
     ...
     */
    public function getBatchWithHttpInfo($version, $batch_id)
    {
        $returnType = '\Swagger\Client\Model\OfferBatch';
        $request = $this->getBatchRequest($version, $batch_id);
     ...
     */
    public function getBatchAsync($version, $batch_id)
    {
        return $this->getBatchAsyncWithHttpInfo($version, $batch_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBatchAsyncWithHttpInfo($version, $batch_id)
    {
        $returnType = '\Swagger\Client\Model\OfferBatch';
        $request = $this->getBatchRequest($version, $batch_id);
     ...
     */
    protected function getBatchRequest($version, $batch_id)
    {
        ...
        $resourcePath = '/{version}/offers/batch/{batch_id}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
